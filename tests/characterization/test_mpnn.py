...
@pytest.mark.hpc
@pytest.mark.wave1
def test_mpnn_cluster_counts_from_cluster_sequences_py(reference_root, output_root):
...
@pytest.mark.hpc
@pytest.mark.wave1
def test_mpnn_corrected_fasta_from_correct_mpnn_sequences_py(reference_root, output_root):
...
@pytest.mark.hpc
@pytest.mark.wave1
def test_qc_metadata_from_sequence_qc_py(reference_root, output_root):
...
@pytest.mark.hpc
@pytest.mark.wave1
def test_qc_report_from_sequence_qc_py(reference_root, output_root):
...
@pytest.mark.hpc
@pytest.mark.wave1
def test_scored_metadata_from_score_design_region_py(reference_root, output_root):
...
@pytest.mark.hpc
@pytest.mark.wave1
def test_sequence_metadata_from_sequence_qc_py(reference_root, output_root):
    """bin/sequence_qc.py — CSV-EXACT."""
...
@pytest.mark.hpc
@pytest.mark.wave1
def test_top_metadata_from_select_top_sequences_py(reference_root, output_root):
...
@pytest.mark.hpc
@pytest.mark.wave1
def test_design_0_seq_0_top_fasta_from_select_top_sequences_py(reference_root, output_root):
